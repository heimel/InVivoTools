...
%   Y = MYFILTFILT(B, A, X) filters the data in vector X with the filter described
...
%
%   Note that MYFILTFILT should not be used with differentiator and Hilbert FIR
%   filters, since the operation of these filters depends heavily on their
%   phase response.
%
%   See also FILTER.
%   
%   (From Matlab, for use while waiting for new license, then replace with FILTFILT.)
