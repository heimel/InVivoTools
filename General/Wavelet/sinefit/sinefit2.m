...
%SINEFIT2 sine wave fitting to noisy sine signal
% phase fitting has to be considered with a fixed omega!
...
% See also "jomega"
%
% 2012 modified by Alexander Heimel
%
...
Theta=atan2(Asintheta,Acostheta);
clear('sot','cot');
sotT = s0-Ahat*sin(omega*t+Theta);
RMS=sqrt(sotT*sotT'/(Np(2)-1.));
