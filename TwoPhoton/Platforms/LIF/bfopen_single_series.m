function [result] = bfopen_single_series(id,series, varargin)
%BF_OPEN_SINGLE_SERIES
%
%  RESULT = BF_OPEN_SINGLE_SERIES(ID,SERIES,VARARGIN)
%
%     ID is lif file name
%     SERIES is seriesnumber
%
% 2014, Alexander Heimel, adapted from BFOPEN
%
...
fprintf('Reading series #%d', s);
    ...
    result{2} = seriesMetadata;
    result{3} = colorMaps;
    result{4} = r.getMetadataStore();
    fprintf('\n');
%end
r.close();