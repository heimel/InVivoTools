function [celllist, new_cell_index] = import_fiji_rois_xls( filename, record, new_cell_index , empty_roi)
...
logmsg(['Imported ' num2str(length(celllist)) ' rois from ' filename]);