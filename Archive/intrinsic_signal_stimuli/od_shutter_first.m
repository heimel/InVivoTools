...
% NO DELAY
%
% 2005-02-16 JFH: Based on fullscreengrating
% 2005-02-16 JFH: Removed initial delay
% 2005-02-18 JFH: Changed contrast from 1 to 0.9
% 2005-02-18 JFH: Changed time from 6 to 3s
% 2005-03-08 JFH: Changed to 0.05 cpd
% 2005-04-13 JFH: Changed to middle of 3 bands
% 2005-???   JFH: Changed to 2 horizontal bands
% 2005-07-21 JFH: Changed to left half of screen only
% 2012-05-17 JFH: Added a 9s delay for showing the stimulus
