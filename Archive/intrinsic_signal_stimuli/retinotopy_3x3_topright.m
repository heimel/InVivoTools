...
%
% 2011-01-10 JFH: Based on retinotopy_3x3_topleft  
% 2011-01-10 JFH: 3x3 stimuli in 320x240 top right quadrant
...
while ~stop
  ...
  if go & ready
    ...
    if stim~=0 % not blank 
        ...
        col=stim-1-row*n_x + n_x; % extra n_x is for right half of screen
        rect=[col*width row*height min((col+1)*width,r(3)) min((row+1)*height,r(4))];
