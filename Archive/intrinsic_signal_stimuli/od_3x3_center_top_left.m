% od_3x3_center_top_left
% 2010-01-10 JFH: Based on OD_DRIFTING
% 2010-01-10 JFH: bottom 2/3 in the center of the top left quarter of the
%                 screen
% NOTE: VERY SPECIALIZED FOR THESE SPECIFIC DIMENSIONS!
...
while ~stop
  ...
  if go & ready
    ...
    if stim~=0 % not blank 
        ...
        col=stim-1-row*n_x;
        rect=[(col+1)*width 480/6 (col+2)*width 480/6+height];
