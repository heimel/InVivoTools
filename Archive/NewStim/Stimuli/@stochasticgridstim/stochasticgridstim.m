...
default_p = struct ( 'BG', [128 128 128], 'dist', [1;8;1;], ...
			'values', [255 255 255; 128 128 128; 0 0 0], ...
                    'rect',[0 0 100 100], 'pixSize', [50 50] ,'N',1500,...
			'fps',5,'randState', rand('state'));
default_p.dispprefs = {};
finish = 1;
...
h1 = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[24.97477854330709 369.8188361220473 216.1278912401575 19.21136811023622], ...
...
bg_ctl = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[247.8266  374.6217  123.9133   18.2508], ...
        'String',bg_str, ...
        'Style','edit', ...
        'Tag','EditText1');
values_ctl = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[28.81705216535431 301.6184793307087 342.9229207677166 43.2255782480315], ...
        'String',values_str, ...
        'Style','edit', ...
        'Tag','EditText1');
h1 = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[24.97477854330709 344.8440575787402 343.8834891732284 19.21136811023622], ...
...
h1 = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[24.97477854330709 277.6042691929134 343.8834891732284 19.21136811023622], ...
...
dist_ctl = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[28.81705216535431 234.3786909448819 342.9229207677166 43.2255782480315], ...
        'String',dist_str, ...
        'Style','edit', ...
        'Tag','EditText1');
pixSize_ctl = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[314.1058686023622 209.4039124015748 57.63410433070867 22.09307332677166], ...
        'String',pixSize_str, ...
        'Style','edit', ...
        'Tag','EditText1');
h1 = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[24.97477854330709 204.6010703740158 277.6042691929134 22.09307332677166], ...
...
N_ctl = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[132.5584399606299 187.3108390748032 30.73818897637796 18.25079970472441], ...
        'String',N_str, ...
        'Style','edit', ...
        'Tag','EditText1');
h1 = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[24.97477854330709 183.4685654527559 99.89911417322836 19.21136811023622], ...
...
h1 = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[194.0348  183.4686  116.2288   19.2114], ...
...
fps_ctl = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[320.8298474409449 188.271407480315 50.91012549212599 18.25079970472441], ...
        'String',fps_str, ...
        'Style','edit', ...
        'Tag','EditText1');
h1 = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[24.97477854330709 162.3360605314961 343.8834891732284 19.21136811023622], ...
...
rs_ctl = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[28.81705216535431 140.2429872047244 342.9229207677166 22.09307332677166], ...
        'String',rs_str, ...
        'Style','edit', ...
        'Tag','EditText1');
dp_ctl = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[28.81705216535431 93.17513533464567 342.9229207677166 22.09307332677166], ...
        'String',dp_str, ...
        'Style','edit', ...
        'Tag','EditText1');
h1 = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position', [24.9748  115.2682  343.8835   19.2114], ...
...
while ~error_free,
   ...
   if get(cancel_ctl,'userdata')==1,
	...
	values_str=get(values_ctl,'String'); dist_str = get(dist_ctl,'String');
	pixSize_str = get(pixSize_ctl,'String'); N_str = get(N_ctl,'String');
   ...
   try, values=eval(values_str);
	catch, errordlg('Syntax error in values');so=0;end
   try, dist = eval(dist_str);
	catch, errordlg('Syntax error in dist');so=0;end;
   ...
   if so,
	...
	sgsp = struct('rect',rect, 'BG',bg, 'values', values, 'dist', dist, ...
...
if get(ok_ctl,'userdata')==1, params = sgsp; else, params = []; end;
delete(h0);
