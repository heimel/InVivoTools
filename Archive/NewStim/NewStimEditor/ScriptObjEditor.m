...
%  one to graphically browse the stimulus objects inside the script and edit
...
commands = {'Update', 'New', 'NewOK', 'Close','SetMethod', 'Method', 'Trigger',...
	    ...
	    'Replace', 'EditDisplayPrefs','EnableDisable'};
iscmd = 0;
...
if iscmd==0,
	...
	switch command,
		case 'Update',
			...
			set(scriptstruct.duration,'String',['Total duration: ' ...
                num2str(fix(dur/60)) ':' ...  % minutes
                num2str(rem(fix(dur),60),'%02d') '.' ... % seconds
                num2str(fix( 10*(dur-fix(dur)))) ' m']); % 10th
...
totdur_ctl = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[465.8757+dmx    9.6057+dmy  127.7556   16.3297], ...
