...
if isempty(RFparams),
	...
	'background',0.5000,'backdrop',0.0000,'barColor',1,'nSmoothPixels',2,...   % 'distance',57
        'fixedDur',0,'windowShape',0,'flickerType',0,'chromhigh',[255 255 255],'chromlow',[0 0 0]);
	PSparams.dispprefs = {'BGpretime',-1,'BGposttime',-1};
	LBparams = struct('rect',RFcurrentrect,'shape',0,'points',[10 5],...
	'units',1,'orientation',45,...  % 'distance',57,
