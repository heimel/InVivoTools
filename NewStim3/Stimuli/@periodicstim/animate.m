function [img, frames, ds_userfield, destination_rect] = animate(PSstim)
...
if PSparams.flickerType==0
    c1 = 1;
    c2 = 0;
elseif PSparams.flickerType==1
    c1 = -1;
    c2 = 0;
elseif PSparams.flickerType==2
    c1 = 1;
    c2 = -1;
end
    ...
    case {2,3}, % sin wave, ramp
        if 0 % this is solution that involves multiple images for each contrast step needed; let's not use this one
            ...
            if PSparams.animType==2
                ...
                tphase_contrast = unique_tphase/(2*pi);
            end
