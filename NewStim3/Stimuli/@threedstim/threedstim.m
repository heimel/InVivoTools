function stim = threedstim(params, OLDSTIM)

%  NewStim package:  threedstim
%        based on stimulus described in Lamme J Neurosci 1995
%
%  STIM = threedstim(PARAMETERS)
%
%  Creates a threedstim object.
%
...
%  may also use
%
%  STIM = threedstim('graphical',OLDSTIM)
%
...
%
%  threedstim('help') gives explanation of all parameters and default values
%
%
...
paramlist(end+1) = cell2struct({'typenumber', '3', [1 nan],[0 inf],'See HELP threedstim'},fields,2);
paramlist(end+1) = cell2struct({'imageType', '2', [1 1],[1 inf],'1 for square-wave, 2 for sinusoid, 9 for texture, see HELP threedstim'},fields,2);
...
s = stimulus(5);
stim = class(struct('params',params),'threedstim',s);
...
h0 = figure('Color',[0.8 0.8 0.8],'menubar','none','units',...
    'points','name','New threedstim object',...
    'numbertitle','off');
