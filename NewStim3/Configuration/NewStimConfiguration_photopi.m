...
Remote_Comm_dir = '/vs01/MVP/Shared/InVivo/Communication/Photopi'; % the local name of folder in which to write
% Remote_Comm_dir = '/home/pi/Temp'; % the local name of folder in which to write
