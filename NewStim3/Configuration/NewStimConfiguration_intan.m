...
%Remote_Comm_dir = '\\vs01.herseninstituut.knaw.nl\MVP\Shared\InVivo\Communication\Robbie'; % the local name of folder in which to write
%   files for communication
Remote_Comm_dir = 'D:\Data\InVivo\Electrophys\Intan\stims';
% settings for Remote_Comm_method = 'sockets'
Remote_Comm_host = '10.0.0.02';
...
Remote_Comm_remoteprefix = 'C:\Data';
...
%pixels_per_cm = 1920/39; % set wrongly probably on 2014-04-14
pixels_per_cm = 1920/51; % set right on 2014-11-10
...
LoadGammaCorrectionTable('gct_andrewstim.txt');
