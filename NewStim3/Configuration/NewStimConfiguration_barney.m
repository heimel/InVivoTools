...
Remote_Comm_isremote = 01; %#ok<*NASGU>
...
Remote_Comm_dir = '/mnt/stims'; % the local name of folder in which to write
...
Remote_Comm_localprefix = '/mnt/data'; % for example, 'Z:', 'z:', '/Users/Shared/myexperimentdir'
% the prefix to the shared directory on THIS computer

Remote_Comm_remoteprefix = '/mnt/data';
...
MonitorWindowMonitor = 1;  % use the given monitor, 0 is first
MonitorComputer = 1;       % does this computer have a monitor window?
...
pixels_per_cm = 1920/50.8;

NewStimViewingDistance = 17.5; %cm, 

NewStimTilt = 0; % degree tilt of screen on monitor

NewStimStimDelay = 15; % delay to give acquisition computers time to start
...
StimSerialScriptOut = '/dev/ttyS0';  %ttyS0   % same
...
NSUseInitialSerialContinuous = 1;
