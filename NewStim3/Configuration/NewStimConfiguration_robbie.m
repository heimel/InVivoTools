...
Remote_Comm_localprefix = '/mnt/nin380/data/'; % for example, 'Z:', 'z:', '/Users/Shared/myexperimentdir'
 % the prefix to the shared directory on THIS computer

Remote_Comm_remoteprefix = '/home/data';
...
LoadGammaCorrectionTable('gct_robbie.txt');
