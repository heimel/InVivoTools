...
blseqst = getstimscripttimestruct(cksds,'t00001')
blseq = stimtimestruct(blseqst,1)
blranst = getstimscripttimestruct(cksds,'t00002')
blran = stimtimestruct(blranst,1)
blsgsst = getstimscripttimestruct(cksds,'t00004')
blsgs = stimtimestruct(blsgsst,1)

inp.spikes = { g.cell_photo_0002_001_2001_10_17};
inp.stimtime = blsgs;
inp.cellnames = { ' test ' };
