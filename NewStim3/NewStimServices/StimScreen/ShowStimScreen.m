...
if A, CloseStimScreen; end;  % call anything that needs to be called if window is closed
...
if A,
	...
	if StimWindowRefresh==0, StimWindowRefresh = 60; end; % fix for some LCDs
