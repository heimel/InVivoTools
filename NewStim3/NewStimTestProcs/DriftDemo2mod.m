...
try
    ...
    masktex2 = ClipRgn2Texture(w,2,CenterRect([0 0 100 200],screenRect),[40 40 40]);
    ...
    while(vbl < vblendtime)
        ...
        if drawmask==1
            ...
            %Screen('DrawTexture', w, masktex2, [0 0 visiblesize visiblesize], dstRect, angle);
            % Draw rectangle mask over grating:
