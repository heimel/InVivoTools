...
Remote_Comm_dir = '\\vs01.herseninstituut.knaw.nl\MVP\Shared\InVivo\Communication\Nin444'; % the local name of folder in which to write
...
StimDebug = 0;      % do you want to show stimuli in 640x480 window
...
pixels_per_cm = 1920/92.8; % jander monitor 2016-02-09

NewStimViewingDistance = 29; %cm, 

NewStimTilt = -10; % degree tilt of screen on monitor
% -10 right cortex, 0 horizontal, 10 left cortex
...
LoadGammaCorrectionTable('gct_nin444.txt'); % set on 2016-03-01, high luminance = 42 cd/m2
