...
Remote_Comm_dir = '/mnt/jander/Data/stims'; % the local name of folder in which to write
                                      %   files for communication

% settings for Remote_Comm_method = 'sockets'
Remote_Comm_host = '192.87.11.116';
...
pixels_per_cm = 1920/92.8; % other monitor 2008-05-14

NewStimViewingDistance = 29.5; %cm, necessary for Alexander

if strmatch(host,'nin444')==1
NewStimTilt = -10; 
end
...
LoadGammaCorrectionTable('gct_nin444.txt');
