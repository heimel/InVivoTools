...
Remote_Comm_dir = '\\vs01.herseninstituut.knaw.nl\MVP\Shared\InVivo\Communication\Helero2p\'; % the local name of folder in which to write
...
StimTriggerAdd('GaiaTrig',struct('daq',0)); % add gaia triggering
