...
pixels_per_cm = 1280/33.5; % other monitor 2008-05-14

NewStimViewingDistance = 50; %cm, necessary for Alexander

NewStimTilt = 0; % degree tilt of screen on monitor

NewStimStimDelay = 10; % delay to give acquisition computers time to start
...
% Webcam
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
gNewStim.Webcam_Serialport_name = '/dev/ttyS0';
