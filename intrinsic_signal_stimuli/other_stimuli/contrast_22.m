...
% 2005-08-02 JFH: Changed to top left quarter
%            contrasts=[0.1 0.4 0.7 0.9]
% 2007-04-20 AH: changed to gabor
% 2007-04-20 AH: added 0.2 to contrasts
% 2008-08-20 AH: added 0.8 to contrasts
% 2008-08-20 AH: changed sf from 0.05 to 0.1 cpd
% 2008-08-20 AH: removed gabor to conform to current sf tests
contrasts=[0.1 0.2 0.4 0.7 0.8 0.9]
