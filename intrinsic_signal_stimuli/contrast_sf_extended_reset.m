% contrast_sf_extended_reset
%
% 2009-09-18 JFH: newly created based on contrast_sf_extended
%             shows 0.1 cpd, 90% contrast stimulus after stim

spatialfrequencies=[0.1 0.2 0.3 0.5];
contrasts=[0.2 0.4 0.60 0.90];
