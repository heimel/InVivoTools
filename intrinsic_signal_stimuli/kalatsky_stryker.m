...
monitorframerate=FrameRate(window)/10;
...
par.tf=0.09987; % to be used with acqtime:580747ms, 12camframperdataframe
%par.tf=0.1257; %Hz, (73 cycles) to be used with acqtime: 580747ms
%par.tf=0.19974; %Hz (116 cycles) to be used with acqtime: 580747ms
%%%%
par.sf=0.0125;   % spatial frequency (cpd)
par.time=1/par.tf;   % time (s) 
