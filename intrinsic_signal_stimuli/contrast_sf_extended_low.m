% contrast_sf_extended_low
%
% show cocktail of reversing gratings at several positions
% stimulus selection from parallel port
%
% 2009-09-14 JFH: newly created, based on contrast_sf
%                 spatialfrequencies=[0.05 0.1 0.2];
%                 contrasts=[0.2 0.4 0.60 0.90];
% 2009-09-16 JFH: added sf=0.3

spatialfrequencies=[0.05 0.1 0.2 0.3];
contrasts=[0.2 0.4 0.60 0.90];
