...
%  NEWCKSDIRSTRUCT = SETACTIVE(MYCKSDIRSTRUCT, DIRLIST,APPEND)
%
%  Sets the cell list of directories (or single character directory name)
%  to be active in the CKSDIRSTRUCT MYCKSDIRSTRUCT, and returns a new
%  CKSDIRSTRUCT.  If a directory does not exist, no error is given but the
