...
%
%  Allows editing of the MULTIEXTRACTOR object ME with name 'NAME' in the
%  main workspace.
%
...
if nargin<=2,
    ...
    params=buildwindow(wd,isname,~isempty(z),name);
    if ~isname
	if isempty(params), nwd = [];
...
function p = buildwindow(wd,isname,hasdata,thename)
...
set(h0,'userdata',struct('title',title,'threshmethodpopup',threshmethodpopup,...
	...
	'filtargstring',filtargstring,'filtarg',filtarg,'wd',wd,'wdname',thename,...
	'browsewind',[]));
