...
%  B = ISACTIVE(MYDIRSTRUCT, DIRNAME)
%
%  Returns 1 if 'DIRNAME' is an active directory in the DIRSTRUCT
%  MYDIRSTRUCT.  DIRNAME may also be a cell list, in which case b will
