...
function [spikeTimes, spikeAmps, spikeDepths, spikeSites] = ksDriftmap(ksDir, localizedSpikesOnly, alignCh)
...
ycoords = sp.ycoords;
% 
% if ~isempty(strfind(ksDir, 'Cabbage')) || ~isempty(strfind(ksDir, 'Flopsie'))
%     ycoords = flipud(sp.ycoords*25);
%     ycoords = ycoords - ycoords(alignCh);
% else
%     ycoords = flipud(sp.ycoords*50);
%     ycoords = ycoords - ycoords(alignCh);
% end
