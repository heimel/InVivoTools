...
function [timeBins, depthBins, allP, normVals] = psthByDepth(spikeTimes, spikeDepths, depthBinSize, timeBinSize, eventTimes, win, bslWin, alignCh, varargin)
...
depthBins = fliplr(depthBinSize:depthBinSize:32*depthBinSize); 
depthBins = depthBins-depthBins(alignCh); 
