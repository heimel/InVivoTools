...
This manual can be found at: [README.md](docs/README.md).

For information on showing visual stimuli check out the manual on the NewStim package (forked from the Van Hooser lab tools) that is included with InVivoTools <https://github.com/heimel/NewStim3/docs/README.md>
