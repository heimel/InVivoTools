...
![](assets/example_odi_record.png)
![](assets/example_odi_300x.png)
...
![](assets/example_odi_2_record.png)
![](assets/example_odi_2_300x.png)
...
![](assets/example_contra_vs_ipsi_record.png)
![](assets/example_contra_vs_ipsi_300x.png)
...
![](assets/example_contra_vs_ipsi_2_record.png)
![](assets/example_contra_vs_ipsi_2_300x.png)
...
![](assets/example_histogram_record.png)
![](assets/example_histogram_300x.png)
...
![](assets/example_cumulative_histogram_record.png)
![](assets/example_cumulative_histogram_300x.png)
...
![](assets/example_psth_record.png)
![](assets/example_psth_300x.png)


### Example puncta gained and lost time series
Gain and loss time series can be made in two ways, which produce the same graph.

![](assets/example_puncta_gain_record.png)

![](assets/example_puncta_gain_record2.png)

![](assets/example_puncta_gain_300x.png)
