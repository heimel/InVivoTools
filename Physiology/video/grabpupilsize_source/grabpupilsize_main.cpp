...
//
// This executable is used to record pupil size measurements and is 
// optimized to function in the InVivo toolbox. It contains the same 
// algorithm as eye_track_algo1.cpp (executable used which is used to
// determine the threshold setting of the binarization step (4) of the
...
//
// Algorithm steps:
//		1. Convert stream into workable array (Mat opencv class).
//		2. Set ROI.
//		3. Apply Gaussian blur.
//		4. Apply threshold -> binarize.
//		5. Morphological closing.
//		6. Canny filter.
//		7. find contour algorithm.
//		8. fit ellipse.
//
//
...
int main(int argc, char* argv[])
{
	...
	//const char* open_config = "d:/software/temp/config_test.cfg";
