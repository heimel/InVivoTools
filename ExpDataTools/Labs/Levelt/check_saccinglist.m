...
db = import_mdb([],[],crit);
strains = '(Transgene=T5)|(Transgene=DBA)|(KOdKI=GCamp3)|(KOdKI=R26TOM)|(Cre=GAD*)|(Cre=Kazu,Typing_KOdKI!hom*,Typing_KOdKI!het*)';
