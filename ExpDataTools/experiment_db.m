...
if exist(avname,'file')
    available_tests = eval(['available_' type 'tests']);
    available_tests_enabled = true;
else
    available_tests_enabled = false;
end
if available_tests_enabled
    h.which_test = ...
        uicontrol('Parent',h_fig, ...
        'Style','popupmenu',...
        'Units','pixels', ...
...
if exist([type '_session_path'],'file')
    h.explore_session = ...
        uicontrol('Parent',h_fig, ...
        'Units','pixels', ...
        'BackgroundColor',0.8*[1 1 1],...
