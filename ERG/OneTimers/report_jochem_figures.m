...
cd 'OneTimers';
data_erg = [];
%this takes some time but after that you're fine
...
figureoutputdir = 'C:\Documents and Settings\cornelij\Desktop\';  

%Figure Constants (used in subsequent figures)
...
figure(1); subplot1(1,4,'Gap',[0.02 0.02],'FontS',11,'YTickL','Margin','Min',[0.45 0.3],'Max',[1,0.94],'FontS',10); hold off; 
set(gcf,'Position',[100 100 1000 800]);
plotcounter = 0;
for mouse = [8 3 5 11]
  for exp = 1:1
