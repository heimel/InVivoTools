function [legend_h,object_h,plot_h,text_strings] = columnlegend(leg_data, numcolumns, str, varargin)
% Azadeh added leg_data
...
if legend_h == false,
    %create the legend
    [legend_h,object_h,plot_h,text_strings] = legend(leg_data, str);
end
%some variables
numlines = length(str);
