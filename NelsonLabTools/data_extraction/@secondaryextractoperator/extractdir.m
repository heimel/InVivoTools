function [newexop,status] = extractdir(exop,pexop,thedir,aqinfo,cksds,instruc);

%  [NEWEXOP,STATUS]=EXTRACTDIR(EXOP,PEXOP,THEDIR,ACQ_OUT_INFO,THECKSDIRSTRUCT,INSTRUC)
%
...
%  instructions given in INSTRUC.  PEXOP is the primary operator used in this
%  
%
