...
%
% [FEATURES,DESCRIPT]=FEATURE_EXTRACTION(CSP,PARAMETERS,CHANNELS) 
% extracts features and gives a description of extracted features
%
% CSP(sample nr,channel nr,spike nr) contains spikes
%
...
%   USECUMSUMPCAS=
%
% May 2002, Alexander Heimel

timewindow=size(csp,1);
splitcsp=csp;
features=[];
