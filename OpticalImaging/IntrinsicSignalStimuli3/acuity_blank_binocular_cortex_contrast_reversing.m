...
pspar.animType = 2; % sine reversing
pspar.flickerType = 2; % counterphase
pspar.tFrequency = 2;
...
angles = [0:pspar.angle:180-pspar.angle] + 10;
...
tic
% show script as test
MTI = DisplayTiming(iss_script(7));
DisplayStimScript(iss_script(7),MTI,0,0);
toc
